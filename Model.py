...
class Model:
    def __init__(self, height, width, channels, model_name, output_size):
        ...
        self.append_var(w, b)
        self.conv_2, w, b = nl.conv2d_layer(self.conv_1, 8, 64, model_name + '-' + 'conv2', strides=[1, 1, 1, 1])
        self.append_var(w, b)
        ...
        self.append_var(w, b)
        self.fully_connected_2, w, b = nl.dense_layer(self.fully_connected_1, 512, model_name + '-' + 'fc2')
        self.append_var(w, b)
        self.keep_prob = None
