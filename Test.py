...
red_corrected = numpy.array([[row[0] for row in column] for column in corrected_screens[0][0][2]], int)
corrected_proc = NLib.preprocess(corrected_screens[0][0][2], 30, 30)
